...
NMI = 11111111111
METER_NO = 123456
# Caps are important! (Consumption/Generation)
CON_GEN = 'Consumption'
# Caps are important! (Yes/No)
ESTIMATED = 'No'
# 14 for free tier, 90 for donor
DAYS_TO_IMPORT = 14
...
data.insert(0, 'NMI', NMI)
data.insert(1, 'METER SERIAL NUMBER', METER_NO)
data.insert(2, 'CON/GEN', CON_GEN)
data.insert(4, 'ESTIMATED?', ESTIMATED)
...
ROWS = len(data.index)-DAYS_TO_IMPORT
...
# Drop index colum, and round import values.
